                                                ...
                                                <div>
                                                    <center><h5>Artist</h5>
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="submit" name="btn_rate" value="Rate It" class="w3-button" style="width: 8em; background-color: #af9398;color: #fff" />
                                                    ...
                                                    <center>
                                                        <div>
                                                            <a href="collector_artist-profile.php?profile=<?php echo $_GET['profile'] ?>">
                                                                <h4 class="w3-button w3-margin-bottom" style="background-color: #af9398;color: #fff;width: 40%;">
                                                                    Profile Information
                                                                </h4>
                                                            </a>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4" style="text-align: center;">
                                                                    ...
                                                                    <hr/>
                                                                    <img src="<?php echo $r['artist_qrimg'] ?>" alt = "<?php echo $r['artist_qrimg'] ?>Not Available" />
                                                                </div>
                                                            </div>
                                                    </center>
                                                <?php } ?>
