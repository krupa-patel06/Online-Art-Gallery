...
$cateoryres = mysqli_query($conn, $cat);
            ...
            <div style="margin-top: 7.5em;">
                ...
                <center>
                    <div class="progress skill-bar " style="width:80%;">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="15" style="background-color:#af9398">
                ...
                <div class="container-login100-form-btn">
                    <!-- <input type="submit" name="btn_previous" class="login100-form-btn" onClick="javascript:history.go(-1)" value="Previous" style="width: 12em" formaction="artist_uploadarts.php"/>  -->
                    <a href="javascript:history.go(-1)" name="btn_previous" class="login100-form-btn" value="Previous" style="width: 12em" formaction="artist_uploadarts.php">Previous</a>
                    &nbsp;&nbsp;
