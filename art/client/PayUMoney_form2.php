...
<body onload="submitPayuForm()">
    ...
    <?php } ?>
    <center>
        <form action="bill.php" method="post" name="payuForm" class="" style="width: 40%; margin-left: 5%;margin-top: 3%;">
            <center>
                ...
                <div class="wrap-input100 validate-input">
                    <input type="text" name="amount" value="<?php echo "Payment Method Is Cash ON Delivery"; ?>" class="input100" readonly="true" />
                </div>
