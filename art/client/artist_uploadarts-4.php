            ...
            <div style="margin-top: 7.5em;">
                ...
                <center>
                    <div class="progress skill-bar " style="width:80%;">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="50" style="background-color:#af9398">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="javascript:history.go(-1)" name="btn_previous" class="login100-form-btn" value="Previous" style="width: 12em" formaction="artist_uploadarts-3.php">Previous</a>
                    &nbsp;&nbsp;
