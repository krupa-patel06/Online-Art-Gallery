                                                        ...
                                                        if (strlen($_POST['password']) >= 8) {
                                                            if ($_POST['password'] != $_POST['confirm_password']) {
                                                                ...
                                                                if (strlen($_POST['contact_number']) == 10 && ($_POST['contact_number'][0] == "9" || $_POST['contact_number'][0] == "8" || $_POST['contact_number'][0] == "7" || $_POST['contact_number'][0] == "6")) {
                                                                    ...
                                                                    if ($count > 0) {
                                                                        echo "<script type=\"text/javascript\">window.alert('Username Already Exists!');window.location.href = 'signupartist.php';</script>";
                                                                        ...
                                                                        $q = "insert into tbl_artist(artist_firstname,artist_lastname,artist_username,artist_password,artist_email,artist_contactnumber,artist_city,artist_state,artist_country,artist_zipcode) values('$firstname','$lastname','$username','$password','$email_id',$contact_number,'$city','$state','$country',$zipcode);";
                                                                        ...
                                                                        if ($countt > 0) {
                                                                            echo "<script type=\"text/javascript\">window.alert('Username Already Exists As Customer!');window.location.href = 'signupartist.php';</script>";
            ...
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <a href="visitor_home.php" class="site-logo-anch">
                        <img src="arts_files/images/logo13.jpg" width="220" height="220" alt="Vision" style="margin-top: 70%;">
                    </a>
                ...
                <form class="login100-form validate-form" method="post" enctype="multipart/form-data">
                    <span class="login100-form-title">
                        <h2 style="color: #af9398">SIGN UP</h2>
                    </span>
                    <hr>
