            ...
            <form method="post">
                <div class="row">
                    <div class="col col-12">
                        <center>
                            <h1 style="font-size:60px; color: #af9398; font-family: serif;">Artists</h1> 
                            <hr/>
                                            ...
                                            <div class="frontside">
                                                <div class="card" >
                                                    <div class="card-body text-center">
                                                        <p><img class="img-fluid" src="<?php echo $r['artist_profileimage'] ?>" alt="<?php $r['artist_profileimage'] ?>"></p>
