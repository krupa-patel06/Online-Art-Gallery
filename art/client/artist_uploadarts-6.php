    ...
    <body>
        ...
        <form method='post' enctype="multipart/form-data">
            <div style="margin-top: 7.5em;">
                <hr>
                <center>
                    <h1 style="font-size:60px;color: #af9398;font-family: serif;">Upload Arts</h1> 
                </center>
                ...
                <center>
                    <div class="progress skill-bar " style="width:80%;">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="80" style="background-color:#af9398">
                ...
                <div>
                    <center>
                        ...
                        <br/>
                        <input type="text" name="description"  class="input100" style="width: 50%; height: 12em;" placeholder="Enter Text Here..."></textarea>
                        <br/>   
                    </center>
                </div>
                <hr>
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="javascript:history.go(-1)" name="btn_previous" class="login100-form-btn" value="Previous" style="width: 12em" formaction="artist_uploadarts-5.php">Previous</a>
                    &nbsp;&nbsp;
            ...
            if (isset($_POST['btn_next'])) {
                ...
                if ($len < 50) {
                    echo "<script>swal('Opps.!', 'Please Enter Minimum 50 Characters Of Description .!', 'error');</script>";
                } else {
