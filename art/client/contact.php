                            ...
                            <div class="media-container media-container--contact fancy-background">
                                <div class="title-wrapper ">
                                    <div class="title-block title-block--contact">
                                        ...
                                        <p class="title-block__title txt-light">Krupa Patel<br>201506100110065<br><a href="../cdn-cgi/l/email-protection.html" class="title-block__title txt-light" >f201506100110065@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column-wrapper">
                            <div class="media-container media-container--contact fancy-background">
                                <div class="title-wrapper ">
                                    <div class="title-block title-block--contact">
                                        <h3 class="title-block__subtitle txt-grey-transparent">Member</h3>
                                        <p class="title-block__title txt-light">Ashvini Kushwaha<br>201506100110070<br><a href="../cdn-cgi/l/email-protection.html" class="title-block__title txt-light" >f201506100110070@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column-wrapper">
                            <div class="media-container media-container--contact fancy-background">
                                <div class="title-wrapper ">
                                    <div class="title-block title-block--contact">
                                        <h3 class="title-block__subtitle txt-grey-transparent">Member</h3>
                                        <p class="title-block__title txt-light">Jeni Nandaniya<br>201506100110070<br><a href="../cdn-cgi/l/email-protection.html" class="title-block__title txt-light" >f201506100110070@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column-wrapper">
                            <div class="media-container media-container--contact fancy-background">
                                <div class="title-wrapper ">
                                    <div class="title-block title-block--contact">
                                        <h3 class="title-block__subtitle txt-grey-transparent">Member</h3>
                                        <p class="title-block__title txt-light">Rutvi Prajapati<br>201506100110070<br><a href="../cdn-cgi/l/email-protection.html" class="title-block__title txt-light" >f201506100110070@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
