        ...
        <div style="margin-top: 7.5em;">
            ...
            <center>
                <div class="progress skill-bar " style="width:80%;">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="30" style="background-color:#af9398">
...
<!--                        <div class="row">
                        ...
                        <div class="container-login100-form-btn">
                            ...
                            <a href="javascript:history.go(-1)" name="btn_previous" class="login100-form-btn" value="Previous" style="width: 12em" formaction="artist_uploadarts-2.php">Previous</a>
                            &nbsp;&nbsp;
                        ...
                        if (!empty($_POST['copies'])) {
                            if (!empty($_POST['copyrights'])) {
                                if ($_POST['copyrights'] == "NO") {
                                    echo "<script>swal('Sorry.!', 'If You Want To Upload Artwork Then Its Must Be Your Copyright..', 'error');</script>";
                                } else {
