...
<body>
    ...
    <div style="margin-top: 7.5em;">
        <hr>
        <center>
            <p style="font-size:60px;color: #af9398;font-family: serif;">Cart <i class="ion-android-cart"></i>
                <label style="font-size:30px;color: #af9398;font-family: serif;"><?php echo "( " . $no . " )" ?></label>
            </p>
                        ...
                        <table class="table table-hover">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if (isset($_REQUEST['cart_id'])) {
                                            ...
                                            $resremove = mysqli_query($conn, $remove);
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    ?>
                                    <!--<td><h3 class="text-center"><?php //echo $amt . " INR";          
                                                                    ?></h3></td>-->
                                    <td class="col-sm-1 col-md-1 text-center" id="<?php echo $r['cart_id'] ?>">
                                        <h3 class="text-center">
                                            <?php
                                            $_SESSION["totalAMT"] = $amt;
                                            echo $amt . " INR";
                                            ?>
                                        </h3>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>   </td>
                                    <td>
                                        <button type="submit" class="btn" style="background-color: #af9398" formaction="collector_shop.php">
                                            <span class="glyphicon glyphicon-shopping-cart"></span> Continue Shopping
                                        </button>
                                    </td>
                                    <td>
                                        <button type="submit" class="btn" style="background-color: #af9398" name="btn_checkout">
                                ...
                                for ($a = 0; $a < sizeof($shop_id); $a++) {
                                    ...
                                    while ($r = mysqli_fetch_assoc($res_q)) {
                                        ...
                                        if ($err == 1) {
                                            ...
                                            header("Location:../client/PayUMoney_form.php");
                                        }
                                    }
                                }
                                for ($a = 0; $a < sizeof($shop_id); $a++) {
