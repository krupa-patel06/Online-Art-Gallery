            ...
            <div class="w3-card w3-round w3-white">
                <div class="w3-container">
                    <?php while ($r = mysqli_fetch_assoc($res_q)) { ?>
                        <br>
                        <p class="w3-center"><img src="<?php echo $r['customer_profileimage'] ?>" class="w3-circle" style="height:200px;width:200px" alt="<?php echo $r['customer_profileimage'] ?>" Image Not Found"></p>
                        ...
                        <center>
                            <a href="collector_profile-account_info.php">
                                <h4 class="w3-button w3-margin-bottom" style="background-color: #af9398;color: #000;width: 100%;">
                                    Account Information
                                </h4>
                            </a>
