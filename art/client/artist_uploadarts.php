        ...
        <div style="margin-top: 7.5em;">
            ...
            <center>
                <div class="progress skill-bar " style="width:80%;">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="1" style="background-color:#af9398">
            ...
            <div>
                <form method='post' enctype="multipart/form-data">
                    ...
                    <center>
                        ...
                        <label>Enter File</label>
                        <div class="wrap-input100">
                            <input class="input100" type="file" name="artfile" id="artfile"  style="width: 50%;">
                            <span class="focus-input100" style="width: 50%;margin-left:25%; "></span>
                        </div>                    
