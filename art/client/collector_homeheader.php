...
$cart = mysqli_query($conn, "select count(*) from tbl_cart where customer_id=$customer_id and cart_status=0");
...
<div id="page_wrapper">
                        ...
                        <div id="logo-container" class="logo-container">
                            <h1 class="site-logo logo " id="logo">
                                <a href="collector_home.php" class="site-logo-anch">
                                    <img class="logo-img site-logo-img" src="arts_files/images/logo13.jpg" width="80" height="80" alt="Vision" title="Agency"> 
                                    <span style="font-size: 40px;color: #af9398">Art Gallery</span>
                                </a>
                            </h1>
                        </div>
                    </div>
    ...
    <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="agency-slider" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.5.1">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-1" data-transition="slidevertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="arts_files/Home/slide02.jpeg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="arts_files/Home/slide01.jpg"  alt=""  data-lazyload="arts_files/Home/slide04.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
