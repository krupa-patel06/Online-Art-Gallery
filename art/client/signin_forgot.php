                ...
                <div class="wrap-login100">
                    <div class="login100-pic js-tilt" data-tilt>
                                <a href="visitor_home.php" class="site-logo-anch">
                                         <img  src="arts_files/images/logo13.jpg" width="220" height="220" alt="Vision"style="margin-top: 10%;"> 
                                </a>                        
                    ...
                    <form class="login100-form validate-form" method="get">
                        ...
                        if (isset($_GET['btn_submit'])) {
                            if (!empty($_GET['txt_email'])) {
                                ...
                                $mail->IsHTML(true);
                                $mail->Username = "gopikalathiya091@gmail.com";
                                $mail->Password = "ostsvoywlifbfisp";
                                $mail->SetFrom("gopikalathiya091@gmail.com");
