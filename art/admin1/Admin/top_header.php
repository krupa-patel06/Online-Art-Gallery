        ...
        <div class="container-fluid ">
            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle">Main Category<b class="caret"></b>

                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="arts_main_add_category.php">Add main Category
                                </a>
                            </li>
                            <li>
                                <a href="arts_main_view_category.php">View main Category</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="arts_sub_add_category.php">Add sub Category
                                </a>
                            </li>
                            <li>
