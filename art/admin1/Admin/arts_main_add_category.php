                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post">
                            <fieldset>
                                ...
                                if (isset($_POST['btnAdd'])) {
                                    ...
                                    $u = "SELECT * FROM tbl_category WHERE category_name='" . $nm . "' ";
                                    $v = mysqli_query($conn, $u);
                                    $counttt = mysqli_fetch_row($v);
                                    if ($counttt > 0) {
                                        echo "<script type=\"text/javascript\">window.alert('Category Already Exists!');window.location.href = 'arts_main_add_category.php';</script>";
                                    } else {
                                            ...
                                            $q->execute();
                                            echo "<script>swal('Done.!', 'Category Added  Successfully.!', 'success');</script>";
                                    }
                                }
                                ?>
                            </fieldset>
