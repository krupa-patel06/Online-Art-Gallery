                            ...
                            <form action="#" class="form-horizontal" enctype="multipart/form-data" method="post">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="txtName" data-required="1" class="span6 m-wrap" required/>
                                        </div>
                                    </div>
...
// if everything is ok, try to upload file
                                            ...
                                            $q = $conn->prepare("insert into tbl_artsgallery (file,name,status) values(?,?,?)");
                                            $q->bind_param("sss", $target_file,$name, $astatus);
                                            $q->execute();
                                        }
                                        ?>
