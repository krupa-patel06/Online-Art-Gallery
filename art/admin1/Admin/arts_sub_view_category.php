                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr align="center">
                                                            ...
                                                            <?php
                                                            $q1 = "select category_name from tbl_category where category_id='$row[2]'";
                                                                            ...
                                                                            <table>
                                                                                <div class="modal-body">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td> <input type="text" name="txtSubCategoryId" value="<?php echo $row[0]; ?>" readonly="true"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td>Sub-Category Name :</td>
                                                                                        <td> <input type="text" name="txtSubCategoryName" value="<?php echo $row[1]; ?>"></td>
                                                                                    </tr>
                                                                                </div>
                                                                            </table>
                                                                        </center>
