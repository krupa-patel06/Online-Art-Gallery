...
<body style="background-color:#FFFFFF;">
    <?php include('Admin/top_header.php') ?>
    <!--/.nav-collapse -->
    </div>
    </div>
    </div>
    <?php include('Admin/left_menu.php') ?>
    <!--/span-->
                                    ...
                                    <div style="width:100%;border-bottom:1px solid #CCCCCC;height:150px;">
                                        ...
                                        <div style="width:49.8%;float:left;text-align:left;text-transform:capitalize;border-right:1px solid #CCCCCC;height:100%;">
                                            <table>
                                                <tr>
                                                    <th>Name:</th>
                                                    <td><b><?php echo $ff['cp_name'] ?></b></td>
                                                </tr>
                                                <tr>
                                                    <th>Address:</th>
                                                    <td><b><?php echo $ff['cp_address'] ?></b></td>
                                                </tr>
                                                <tr>
                                                    <th>Contact:</th>
                                                    <td><b><?php echo $ff['cp_contact'] ?></b></td>
                                                </tr>
                                                <tr>
                                                    <th>Mobile:</th>
                                                    <td><b><?php echo $ff['cp_alternative_contact'] ?></b></td>
                                                </tr>
                                        ...
                                        <div style="width:50%;float:left;text-align:left;text-transform:capitalize;">
                                            ...
                                            <table>
                                                <tr>
                                                    <th>Order ID:</th>
                                                    <td><b><?php echo $ff['cp_id'] ?></b></td>
                                                </tr>
                                                <tr>
                                                    <th>Tracking ID:</th>
                                                    <td><b><?php echo $ff['cp_code'] ?></b></td>
                                                </tr>
                                                <tr>
                                                    <th>Order date:</th>
                                                    <td><b><?php echo $ff['cp_date'] ?></b></td>
                                                </tr>
